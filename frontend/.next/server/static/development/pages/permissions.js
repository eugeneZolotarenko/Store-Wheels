...
var _jsxFileName = "C:\\Users\\User\\Desktop\\Advanced-React\\store-wheels\\frontend\\components\\Permissions.js";
...
var PermissionBlock = styled_components__WEBPACK_IMPORTED_MODULE_7___default.a.footer.withConfig({
  displayName: "Permissions__PermissionBlock",
  componentId: "s734rc-0"
})(["min-height:calc(100vh - 248px);padding-top:25px;"]);
var headerStyle = {
  textAlign: "center",
...
var Permissions = function Permissions(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Query"], {
    ...
    var data = _ref.data,
        ...
        error = _ref.error;
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PermissionBlock, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 55
      },
      ...
      __self: this
    }, "Manage Permissions of Users"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_Table__WEBPACK_IMPORTED_MODULE_4__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 59
      },
      ...
      __self: this
    }, "Upadate"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 70
      },
...
function (_React$Component) {
  ...
  function UserPermissions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePermissionChange", function (e, updatePermissions) {
      var checkbox = e.target; // take a copy of the current pormission

      var updatedPermissions = _toConsumableArray(_this.state.permissions);

      console.log(updatedPermissions); // Figuring out needing of removing or adding this permission
...
_defineProperty(UserPermissions, "propTypes", {
  user: prop_types__WEBPACK_IMPORTED_MODULE_6___default.a.shape({
    ...
    eamil: prop_types__WEBPACK_IMPORTED_MODULE_6___default.a.string,
...
var _jsxFileName = "C:\\Users\\User\\Desktop\\Advanced-React\\store-wheels\\frontend\\components\\PleaseSignIn.js";
...
})(["border-spacing:0;width:100%;border:1px solid ", ";box-shadow:0px 4px 18px 0px ", ";padding:5px;border-radius:10px;max-width:calc(", " + 30px);margin:auto;thead{font-size:10px;}td,th{border-bottom:1px solid ", ";border-right:1px solid ", ";position:relative;&:last-child{border-right:none;width:150px;button{width:100%;}}label{padding:10px 5px;display:block;}}tr{&:hover{background:", ";}}"], function (props) {
  return props.theme.olive;
}, function (props) {
  return props.theme.olive;
}, function (props) {
...
var _jsxFileName = "C:\\Users\\User\\Desktop\\Advanced-React\\store-wheels\\frontend\\pages\\permissions.js";
