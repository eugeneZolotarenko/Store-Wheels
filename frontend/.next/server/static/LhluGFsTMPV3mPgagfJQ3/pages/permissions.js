...
var PermissionBlock = external_styled_components_default.a.footer.withConfig({
...
var Permissions_Permissions = function Permissions(props) {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    var data = _ref.data,
        loading = _ref.loading,
        error = _ref.error;
    return external_react_default.a.createElement(PermissionBlock, null, external_react_default.a.createElement(ErrorMessage["a" /* default */], {
      error: error
    ...
    }), external_react_default.a.createElement("th", null, "Upadate"))), external_react_default.a.createElement("tbody", null, data.users.map(function (user) {
