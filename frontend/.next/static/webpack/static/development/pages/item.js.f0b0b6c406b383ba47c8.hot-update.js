...
var addCartSpinner = css(_templateObject());
...
})(["max-width:", ";margin:0 auto;display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:calc(100vh - 69px);.item-image{width:80%;height:80%;object-fit:contain;align-self:center;justify-self:center;@media (max-width:800px){width:100%;height:100%;}}.datails{display:flex;align-items:center;justify-content:center;flex-direction:column;padding:2rem 1rem;box-sizing:border-box;h2{font-size:2.5rem;text-align:center;}.buttonList{margin:1em 0;a,button{background-color:", ";border:none;color:white;font-family:Montserrat;border-radius:10px;font-size:18px;padding:5px 10px;margin:5px;transition:0.3s;cursor:pointer;&:hover{background:", ";box-shadow:", ";}}}}"], function (props) {
...
//# sourceMappingURL=item.js.f0b0b6c406b383ba47c8.hot-update.js.map