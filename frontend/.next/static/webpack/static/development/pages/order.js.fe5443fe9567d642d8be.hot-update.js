...
})(["max-width:1000px;margin:5% auto;border-radius:10px;box-shadow:0px 4px 18px 0px ", ";padding:2rem;border-top:10px solid ", ";border-bottom:10px solid ", ";overflow-x:auto;& > p{display:grid;grid-template-columns:1fr 5fr;margin:0;border-bottom:1px solid ", ";span{padding:1rem;&:first-child{font-weight:900;text-align:right;}}}.order-item{border-bottom:1px solid ", ";display:grid;grid-template-columns:300px 1fr;align-items:center;grid-gap:2rem;margin:2rem 0;padding-bottom:2rem;img{width:100%;height:100%;object-fit:contain;@media(max-width:500px){width:80%;height:80%;}}@media(max-width:500px){grid-auto-flow:column;}}"], function (props) {
...
//# sourceMappingURL=order.js.fe5443fe9567d642d8be.hot-update.js.map