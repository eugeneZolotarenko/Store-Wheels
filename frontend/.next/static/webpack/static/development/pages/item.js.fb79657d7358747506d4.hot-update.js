...
})(["max-width:", ";margin:0 auto;display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:calc(100vh - 69px);@media (max-width:450px){grid-auto-flow:row;}.item-image{width:80%;height:80%;object-fit:contain;align-self:center;justify-self:center;@media (max-width:800px){width:100%;height:100%;}@media (max-width:450px){width:150%;height:150%;}}.datails{display:flex;align-items:center;justify-content:center;flex-direction:column;padding:2rem 1rem;box-sizing:border-box;h2{font-size:2.5rem;text-align:center;}.buttonList{justify-content:center;flex-wrap:wrap;display:flex;margin:1em 0;width:100%;a,button{background-color:", ";border:none;color:white;font-family:Montserrat;border-radius:10px;font-size:18px;padding:5px 10px;margin:5px;transition:0.3s;cursor:pointer;&:hover{background:", ";box-shadow:", ";}}.loading-add-btn{min-width:125.5px;}}}"], function (props) {
...
//# sourceMappingURL=item.js.fb79657d7358747506d4.hot-update.js.map