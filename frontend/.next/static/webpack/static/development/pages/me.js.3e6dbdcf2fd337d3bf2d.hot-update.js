...
})(["max-width:calc(", " + 30px);margin:0 auto;padding:0 15px;h3{text-align:center;color:", ";font-size:190%;}.permissions-block,.orders-block{display:flex;flex-wrap:wrap;align-items:center;justify-content:center;margin-bottom:20px padding:2.5rem;background:white;border-radius:10px;box-shadow:0px 4px 18px 0px ", ";a{display:block;justify-self:center;color:white;padding:0.5rem;}}p{font-size:1.8rem;margin:0;padding:1.5rem 1.5rem 2.5rem 1.5rem;}"], function (props) {
...
//# sourceMappingURL=me.js.3e6dbdcf2fd337d3bf2d.hot-update.js.map